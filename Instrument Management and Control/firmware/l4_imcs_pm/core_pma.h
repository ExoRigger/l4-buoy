...
class CorePMA {
  ...
  public:
      ...
      ProfetPMM(1,1,M1_P_CH_1[0],M1_P_CH_1[1],M1_P_CH_1[2],0,M1_P_CH_1[3]),
      ProfetPMM(1,2,M1_P_CH_2[0],M1_P_CH_2[1],M1_P_CH_2[2],0,M1_P_CH_2[3]),
      ProfetPMM(1,3,M1_P_CH_3[0],M1_P_CH_3[1],M1_P_CH_3[2],0,M1_P_CH_3[3]),
      ProfetPMM(1,4,M1_P_CH_4[0],M1_P_CH_4[1],M1_P_CH_4[2],0,M1_P_CH_4[3]),
      ProfetPMM(2,5,M2_P_CH_1[0],M2_P_CH_1[1],M2_P_CH_1[2],3,M2_P_CH_1[3]),
      ProfetPMM(2,6,M2_P_CH_2[0],M2_P_CH_2[1],M2_P_CH_2[2],3,M2_P_CH_2[3]),
      ProfetPMM(2,7,M2_P_CH_3[0],M2_P_CH_3[1],M2_P_CH_3[2],3,M2_P_CH_3[3]),
      ProfetPMM(2,8,M2_P_CH_4[0],M2_P_CH_4[1],M2_P_CH_4[2],3,M2_P_CH_4[3]),
      ProfetPMM(3,9,M3_P_CH_1[0],M3_P_CH_1[1],M3_P_CH_1[2],6,M3_P_CH_1[3]),
      ProfetPMM(3,10,M3_P_CH_2[0],M3_P_CH_2[1],M3_P_CH_2[2],6,M3_P_CH_2[3]),
      ProfetPMM(3,11,M3_P_CH_3[0],M3_P_CH_3[1],M3_P_CH_3[2],6,M3_P_CH_3[3]),
      ProfetPMM(3,12,M3_P_CH_4[0],M3_P_CH_4[1],M3_P_CH_4[2],6,M3_P_CH_4[3]),
      ProfetPMM(4,13,M4_P_CH_1[0],M4_P_CH_1[1],M4_P_CH_1[2],9,M4_P_CH_1[3]),
      ProfetPMM(4,14,M4_P_CH_2[0],M4_P_CH_2[1],M4_P_CH_2[2],9,M4_P_CH_2[3]),
      ProfetPMM(4,15,M4_P_CH_3[0],M4_P_CH_3[1],M4_P_CH_3[2],9,M4_P_CH_3[3]),
      ProfetPMM(4,16,M4_P_CH_4[0],M4_P_CH_4[1],M4_P_CH_4[2],9,M4_P_CH_4[3]),
    };
